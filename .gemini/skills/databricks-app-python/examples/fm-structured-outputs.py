    ...
    try:
        ...
        retry_response = client.chat.completions.create(
            ...
            messages=[
                ...
                {
                    "role": "user",
                    "content": "Return ONLY minified JSON object. Strings must be JSON-escaped. No extra text.",
                },
                {"role": "user", "content": user_prompt},
            ],
            max_tokens=2000,
...
# =============================================================================
def evaluate_content_quality(client: OpenAI, text: str) -> tuple[dict[str, Any], int]:
