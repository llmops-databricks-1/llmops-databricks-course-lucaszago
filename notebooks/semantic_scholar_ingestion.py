...
DEFAULT_QUERY = "(llm OR \"large language model\" OR rag OR \"retrieval augmented generation\")"
...
def fetch_semantic_scholar_papers(
	...
	for page in range(1, max_pages + 1):
		...
		logger.info(
			f"Semantic Scholar page {page}: retrieved {len(batch)} papers"
		)
...
papers_df.select("title", "citation_count", "paper_id") \
