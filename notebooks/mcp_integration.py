...
vs_mcp_client = DatabricksMCPClient(server_url = vector_search_mcp_url, 
                                     workspace_client = w)
...
if hasattr(cfg, 'genie_space_id') and cfg.genie_space_id:
    ...
    genie_mcp_client = DatabricksMCPClient(server_url = genie_mcp_url, 
                                           workspace_client = w)
    ...
    logger.info("To use genie tools, add 'genie_space_id' to your project_config.yml with the ID of your genie space")
